        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            <div className="font-extrabold text-[var(--text-strong)] tracking-tight">
              Tariff<span className="grad-text">Lens</span>
            </div>
            <div className="text-[10px] text-[var(--text-faint)] -mt-0.5">HS Code &amp; Duty Lookup</div>
          </div>
        </div>

        <nav className="hidden md:flex items-center gap-1">
          {[["Classify", "#classify"], ["How it works", "#how"], ["Tech", "#tech"]].map(([l, h]) => (
            <a key={l} href={h}
