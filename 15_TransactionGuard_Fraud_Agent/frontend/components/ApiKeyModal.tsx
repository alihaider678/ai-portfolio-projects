    ...
    <AnimatePresence>
      {dialogOpen && (
        <motion.div
          ...
          <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" onClick={() => setDialogOpen(false)} />
          <motion.div
            ...
            <p className="text-sm text-[var(--text-muted)] mt-2 leading-relaxed">
              Every investigation runs 3-6 GPT-4o calls. Paste your own key to run unlimited
              investigations, or close this and use the rate-limited shared demo key instead.
            </p>
